...
> [!IMPORTANT]
> **Yêu cầu hạ tầng:** Hệ thống được triển khai on-premise trên hạ tầng máy chủ riêng của đơn vị, hoạt động hoàn toàn độc lập, không phụ thuộc vào các dịch vụ trả phí hoặc nền tảng đám mây (Cloud) của bên thứ ba nhằm đảm bảo an toàn thông tin tuyệt đối.
...
- **GIS & Bản đồ:** Leaflet và React Leaflet.
  - _Bản đồ nền:_ Sử dụng OpenStreetMap (OSM) Tile Layer làm nền.
