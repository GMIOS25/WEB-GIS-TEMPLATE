...
ALTER TABLE gis_provinces
ADD CONSTRAINT gis_provinces_province_code_fkey FOREIGN KEY (province_code) REFERENCES provinces (code);
...
ALTER TABLE gis_wards
ADD CONSTRAINT gis_wards_ward_code_fkey FOREIGN KEY (ward_code) REFERENCES wards (code);
