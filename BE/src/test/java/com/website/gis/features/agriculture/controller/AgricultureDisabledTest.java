...
@TestPropertySource(properties = "features.agriculture.enabled=false")
...
class AgricultureDisabledTest {
    ...
    void whenAgricultureDisabled_thenEndpointReturns404() throws Exception {
